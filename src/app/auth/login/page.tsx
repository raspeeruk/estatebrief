  ...
  if (sent) {
    return (
      <div className="min-h-screen bg-[#F0EBE1] flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-[#FAF6F0] border border-[#DDD4C5] rounded-xl p-8 text-center">
  ...
  return (
    <div className="min-h-screen bg-[#F0EBE1] flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-[#FAF6F0] border border-[#DDD4C5] rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              className="w-full text-sm border border-[#DDD4C5] rounded-xl px-3 py-2.5 bg-white text-[#3D2B1F] placeholder:text-[#7A6A5A]/50 focus:outline-none focus:ring-2 focus:ring-[#7C5C3A] mb-4"
            />
            ...
            <button
              ...
              className="w-full bg-[#7C5C3A] text-white text-sm font-medium rounded-xl px-4 py-2.5 hover:bg-[#664B2E] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <p className="text-xs text-[#7A6A5A] text-center mt-5">
            No account? <Link href="/auth/signup" className="text-[#7C5C3A] font-medium hover:underline">Start free trial</Link>
          </p>
        </div>
      </div>
    </div>
